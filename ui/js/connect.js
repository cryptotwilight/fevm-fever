...
var chain = {};
chain.name = 'Filecoin — Wallaby testnet';
chain.id =  31415;
chain.rpcUrls = ['https://wallaby.node.glif.io/rpc/v0'];
chain.blockExplorerUrls = ['https://explorer.glif.io/wallaby'];
var nativeCurrency = {}; 
nativeCurrency.name = 'tFIL';
nativeCurrency.decimals = 18;
nativeCurrency.symbol = 'TFIL';
...
function loadWait() { 
    ...
    setTimeout(loadPageData, 100000);
